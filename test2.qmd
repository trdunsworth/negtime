...
| STEP_4 | `{r} print(delta_step4_neg)` | `{r} print(delta_step4_na)` | `{r} print(round(delta_step4_neg/(nrow(df)-delta_step4_na)*100, digits=2))` |



Quick notes: We should not use TimeCallViewed in the process. There are too many missing values 